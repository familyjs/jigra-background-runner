...
@objc protocol JigraGeolocationExports: JSExport {
...
enum JigraGeolocationErrors: Error, Equatable {
    case unauthorized
}

class JigraGeolocation: NSObject, JigraGeolocationExports, CLLocationManagerDelegate {
    ...
    func startWatchingPosition(_ highAccuracy: Bool) {
        do {
            if JigraGeolocation.checkPermission() != "granted" {
                throw JigraGeolocationErrors.unauthorized
            }
