#ifndef JIGRA_BACKGROUND_RUNNER_RUNNER_H
#define JIGRA_BACKGROUND_RUNNER_RUNNER_H
...
class Runner {
 public:
  ...
  Context *create_context(std::string name, JigraInterface *jig_api);
...
#endif  // JIGRA_BACKGROUND_RUNNER_RUNNER_H
