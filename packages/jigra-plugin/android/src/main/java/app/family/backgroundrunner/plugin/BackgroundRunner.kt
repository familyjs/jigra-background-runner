package app.family.backgroundrunner.plugin
...
import app.family.android_js_engine.Context
import app.family.android_js_engine.NativeJigraAPI
import app.family.android_js_engine.NativeJSFunction
import app.family.android_js_engine.Runner
import app.family.backgroundrunner.plugin.api.Device
import app.family.backgroundrunner.plugin.api.Geolocation
import app.family.backgroundrunner.plugin.api.KV
import app.family.backgroundrunner.plugin.api.Notifications
...
class BackgroundRunner(context: android.content.Context) {
    ...
    private fun loadRunnerConfig(assetManager: AssetManager): RunnerConfig {
        BufferedReader(InputStreamReader(assetManager.open("jigra.config.json"))).use { reader ->
