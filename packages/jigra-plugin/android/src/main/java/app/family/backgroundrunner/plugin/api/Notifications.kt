package app.family.backgroundrunner.plugin.api
...
import com.getjigra.plugin.util.AssetUtil
...
class Notifications(context: Context) : NotificationsAPI {
    ...
    init {
        ...
        this.config = JigConfig.loadDefault(context)
